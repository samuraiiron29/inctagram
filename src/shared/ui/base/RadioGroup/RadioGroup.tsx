            ...
            {options.map(({label, value}) => (
                <Fragment key={value}>
                    <label
                        ...
                        htmlFor={value}
                        className={`relative inline-flex items-center gap-[10px] ${!disabled && 'cursor-pointer'} group`}
                    >
                        {/* Кружок */}
                        ...
                        <span className={`text-sm select-none text-[var(--light-100)] ${disabled && 'opacity-50'}`}>
                            {label}
                        </span>
                    </label>
                </Fragment>
