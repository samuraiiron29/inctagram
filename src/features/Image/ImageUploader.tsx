...
//   const handleOnClose = () => setShowModal(false)
//   useClickOutside(contentRef, handleOnClose)
//   // useEffect(() => {
//   //   if (!open) return
...
//     { id: '2', name: 'B/W', value: 'grayscale(100%)' },
//     { id: '3', name: 'Sepia', value: 'sepia(100%)' },
//     { id: '4', name: 'Bright', value: 'brightness(150%)' },
//     { id: '5', name: 'Contrast', value: 'contrast(150%)' },
//     { id: '6', name: 'Blur', value: 'blur(3px)' },
//   ].map(({ id, name, value }) => <option key={id} value={value} children={name} className="bg-black/60" />)

//   return (
//     <div className="fixed inset-0 z-50 flex items-center justify-center" aria-modal="true" role="dialog">
//       <div className="absolute inset-0 bg-black/60" onClick={() => mode !== 'empty' && setShowModal(true)} />
//       {showModal && mode !== 'empty' && (
//         <Modal open={showModal} onClose={handleOnClose} modalTitle={'close'} width={'380px'}>
...
//               children={'Discard'}
//             />
//             <Button variant={'primary'} onClick={handleOnClose} children={'Save draft'} />
//           </div>
//         </Modal>
//       )}
//       <div
...
//                 <Image src="/back-vector.svg" alt="Назад" width={12} height={12} />
//               </button>
//               <h2 className="text-base font-semibold" children={'Publication'} />
//               <button onClick={handlePublish} className="text-primary-400 font-medium" children={'Publish'} />
//             </>
//           )}
//         </div>
...
//                     }}
//                   >
//                     <option value={1} className="bg-black/60" children={'1 : 1'} />
//                     <option value={16 / 9} className="bg-black/60" children={'16 : 9'} />
//                     <option value={4 / 3} className="bg-black/60" children={'4 : 3'} />
//                     <option value={0} className="bg-black/60" children={'Free'} />
//                   </select>
//                 </label>
...
//                   >
//                     {filterItem}
//                     {/* <option value="none" className="bg-amber-400">
//                       None
//                     </option>
//                     <option value="grayscale(100%)" className="bg-amber-400">
//                       B/W
//                     </option>
