...
const ForgotPasswordPage = () => {
  const { methods, onSubmit, modal, closeModal, captchaVerified, setCaptchaVerified, isValid } = useForgotPassword()
      ...
      <div className="w-[378px]">
        <FormProvider {...methods}>
          <Cards onSubmit={onSubmit}>
            <h1 className="text-center text-h1" children={'Forgot Password'} />
            {modal.open && (
            ...
            <div className="flex flex-col space-y-[24px] mt-5">
              ...
              <Link href={PATH.LOGIN} className="text-h3 text-center block text-accent-500 " children={'Back to Sign In'} />
            </div>
            <div className="mt-5">
