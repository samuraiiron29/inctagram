        ...
        <FormProvider {...methods}>
          <Cards onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="flex flex-col space-y-[24px] mt-5">
              <Button type="submit" variant="primary" width="100%" disabled={!captchaVerified || !isValid}>
                Send Link
              </Button>
              <Link href={'/auth/login'} className="text-h3 text-center block text-[#397DF6] weight-600">
                Back to Sign In
              </Link>
            </div>
          </Cards>
